...
export default function LoginPage() {
    ...
    useEffect(() => {
        ...
        if (storedRedirectUrl) {
            ...
            // Show toast on arrival at the login page
            toast('Please log in to add items to your cart', {
                id: 'login-cart-notice',
                icon: 'ℹ️',
                duration: 3500
            })
        }
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-br from-white via-indigo-50 to-blue-100 px-4">
            {/* Ensure a Toaster is mounted here if you do not mount one globally */}
            ...
            <div className="bg-white border border-gray-200 shadow-xl rounded-2xl w-full max-w-md p-8">
                ...
                {redirectUrl !== '/' && (
                    <div className="mb-6 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-sm text-blue-700 text-center">Please log in to add items to your cart</p>
                    </div>
                )}
